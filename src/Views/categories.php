    ...
    <div class="container">
        ...
        <div class="categories-section">
            <div class="category-form-card">
                ...
                <form action="<?= BASE_URL ?>/?page=add_category" method="POST" class="form-inline">
            ...
            <table class="categories-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= BASE_URL ?>/?page=edit_category&id=<?= $cat['id'] ?>" class="btn-edit">✎ Modifier</a>
                            <a href="<?= BASE_URL ?>/?page=delete_category&id=<?= $cat['id'] ?>" class="btn-delete" onclick="return confirm('Supprimer cette catégorie ?')">🗑️ Supprimer</a>
                        </td>
                    </tr>
                    <?php 
                        endforeach;
