...
<head>
    ...
    <style>
        ...
        /* COULEUR SOLDE JOURNALIER - VIOLET */
...
<body>
    ...
    <div class="container">
        ...
        <div class="legend">
            ...
            <div class="legend-item">
                <div class="legend-color" style="background: #8e44ad; border: 2px solid #8e44ad;"></div>
                <span>Solde Journalier (Violet)</span>
            </div>
        </div>
    ...
    <!-- Popup pour modifier/ajouter une transaction -->
    ...
    <script>
                    ...
                    if (transactions && transactions.length > 0) {
                        ...
                        transactions.forEach(function(trans) {
                            ...
                            item.onclick = function() {
                                document.querySelectorAll('.transaction-item').forEach(function(i) {
        ...
        function saveTransaction() {
            ...
            console.log('saveTransaction:', { transactionId, category, date, type, amount });
            ...
            form.method = 'POST';
            form.action = '<?= BASE_URL ?>/?page=' + (transactionId ? 'update_transaction' : 'store_from_calendar');
        ...
        function deleteTransaction() {
            ...
            console.log('deleteTransaction:', { transactionId, date });
            ...
            // Créer un formulaire POST
            var form = document.createElement('form');
            form.method = 'POST';
            form.action = '<?= BASE_URL ?>/?page=delete_from_calendar';
            ...
            console.log('Form data:', { id: transactionId, date: date });
